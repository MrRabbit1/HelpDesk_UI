...
WebUI.setEncryptedText(findTestObject('TypeOfService/Type of service-05/Page_ODTS System/input_ODTS_password'), 
    'aeHFOx8jV/A=')
...
WebUI.setText(findTestObject('TypeOfService/Type of service-05/Page_ODTS System/input_Tn Dch V_siNameC'), 
    'anhtest')

WebUI.waitForAlert(1)

WebUI.setText(findTestObject('TypeOfService/Type of service-05/Page_ODTS System/input_M T Dch V_siDescriptionC'), 
    'haha')
...
try {
	writer = new BufferedWriter(new OutputStreamWriter(
		  new FileOutputStream("C:\\Users\\pc\\HelpdeskAutomation\\creDateService.txt"), "utf-8"));
	writer.write(CDATE);
