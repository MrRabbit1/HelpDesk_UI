...
WebUI.setEncryptedText(findTestObject('TypeOfService/Type of service-02/Page_ODTS System/input_ODTS_password'), 
    'aeHFOx8jV/A=')
...
try {
		...
		br = new BufferedReader(new FileReader("C:\\Users\\pc\\HelpdeskAutomation\\upDateTypeOfService.txt"))
		sCurrentLine;
			while ((sCurrentLine = br.readLine()) != null) {
				UDATE = sCurrentLine;
			}
