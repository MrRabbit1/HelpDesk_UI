...
WebUI.setEncryptedText(findTestObject('TypeOfService/Type of service-01/Page_ODTS System/input_ODTS_password'), 
    'aeHFOx8jV/A=')
...
WebUI.setText(findTestObject('TypeOfService/Type of service-01/Page_ODTS System/input_Tn Dch V_stsNameCreate'), 
    'anhtest')

WebUI.waitForAlert(1)

WebUI.setText(findTestObject('TypeOfService/Type of service-01/Page_ODTS System/input_M T_sisDescriptionCreate'), 
    'hihi')
...
try {
	writer = new BufferedWriter(new OutputStreamWriter(
		  new FileOutputStream("C:\\Users\\pc\\HelpdeskAutomation\\creDateTypeOfService.txt"), "utf-8"));
	writer.write(CDATE);
	//Lưu ngày tạo vào file
	
	writer2 = new BufferedWriter(new OutputStreamWriter(
		new FileOutputStream("C:\\Users\\pc\\HelpdeskAutomation\\upDateTypeOfService.txt"), "utf-8"));
	writer2.write(CDATE);
	//Lưu ngày cập nhật là ngày tạo vào file
