...
PrintWriter writer2 = new PrintWriter("C:\\Users\\pc\\HelpdeskAutomation\\creDateCompany.txt");
writer2.print("");
writer2.close();
//Xóa ngày tạo

PrintWriter writer = new PrintWriter("C:\\Users\\pc\\HelpdeskAutomation\\upDateCompany.txt");
writer.print("");
writer.close();
//Xóa ngày cập nhật
